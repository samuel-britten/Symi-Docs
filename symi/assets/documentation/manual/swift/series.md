...
`UniffiAssumptionScope.taylorSeries(target: UniffiExpression, variable: String, expansionPoint: UniffiExpression, truncationOrder: UInt64) -> UniffiExpression`

<a id="placement-placement.swift.swift_object.uniffiexpression_taylorseries.c30668e0ffad"></a>
`UniffiExpression.taylorSeries(variable: String, expansionPoint: UniffiExpression, truncationOrder: UInt64) -> UniffiExpression`

<a id="placement-placement.swift.swift_object.uniffisession_taylorseries.b5a9243f757b"></a>
`UniffiSession.taylorSeries(target: UniffiExpression, variable: String, expansionPoint: UniffiExpression, truncationOrder: UInt64) -> UniffiExpression`
...
`UniffiExpression.maclaurinSeries(variable: String, truncationOrder: UInt64) -> UniffiExpression`

<a id="placement-placement.swift.swift_object.uniffisession_maclaurinseries.39fc85963c95"></a>
`UniffiSession.maclaurinSeries(inputExpression: UniffiExpression, variable: String, truncationOrder: UInt64) -> UniffiExpression`
...
`UniffiExpression.laurentSeries(variable: String, center: UniffiExpression, order: UInt64) -> UniffiExpression`

<a id="placement-placement.swift.swift_object.uniffisession_laurentseries.bd7b8d506246"></a>
`UniffiSession.laurentSeries(target: UniffiExpression, variable: String, center: UniffiExpression, order: UInt64) -> UniffiExpression`
...
`UniffiExpression.residue(variable: String, center: UniffiExpression) -> UniffiExpression`

<a id="placement-placement.swift.swift_object.uniffisession_residue.7c671367a502"></a>
`UniffiSession.residue(inputExpression: UniffiExpression, variable: String, center: UniffiExpression) -> UniffiExpression`
...
`UniffiExpression.poleOrder(variable: String, center: UniffiExpression) -> Int64?`

<a id="placement-placement.swift.swift_object.uniffisession_poleorder.8838e6a5ee33"></a>
`UniffiSession.poleOrder(inputExpression: UniffiExpression, variable: String, center: UniffiExpression) -> Int64?`
