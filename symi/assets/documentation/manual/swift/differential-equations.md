...
*Not exposed by the Swift bindings. Available as [`api::DifferentialEquationSolutionScope`](/symi/rust/differential-equations#differentialequationsolutionscope) in Rust.*
