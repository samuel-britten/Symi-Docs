...
*Not exposed by the Python bindings. Available as [`api::UndefinedFunction::name`](/symi/rust/undefined-functions#undefinedfunction_name) in Rust.*
...
*Not exposed by the Python bindings. Available as [`api::UndefinedFunction::session`](/symi/rust/undefined-functions#undefinedfunction_session) in Rust.*
...
*Not exposed by the Python bindings. Available as [`api::UndefinedFunction::generation`](/symi/rust/undefined-functions#undefinedfunction_generation) in Rust.*
...
*Not exposed by the Python bindings. Available as [`api::UndefinedFunction::is_stale`](/symi/rust/undefined-functions#undefinedfunction_is_stale) in Rust.*
...
Build an unknown function, call it, and differentiate it structurally.
...
equation = y.derivative([1], [x]) - y(x)
print(equation)
print(context.solve_ordinary_differential_equation(equation, y(x), "x"))
```
