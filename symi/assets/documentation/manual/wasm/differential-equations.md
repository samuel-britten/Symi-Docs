...
*Not exposed by the WASM / JavaScript bindings. Available as [`api::DifferentialEquationSolutionScope`](/symi/rust/differential-equations#differentialequationsolutionscope) in Rust.*
