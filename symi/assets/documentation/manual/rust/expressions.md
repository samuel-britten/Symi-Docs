...
`symi::api::Expression — pub fn divide(&self, other: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_session_divide.3be2ac0518ec"></a>
`symi::api::Session — pub fn divide(&self, numerator: &Expression, denominator: &Expression) -> Result<Expression, ApiError>`


### power

<a id="placement-placement.rust.native_rust.api_expression_power.3c943db56bb2"></a>
`symi::api::Expression — pub fn power(&self, exponent: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_session_power.26bddf083c5b"></a>
`symi::api::Session — pub fn power(&self, base: &Expression, exponent: &Expression) -> Result<Expression, ApiError>`


### negate

<a id="placement-placement.rust.native_rust.api_expression_negate.485b3e26d6cc"></a>
`symi::api::Expression — pub fn negate(&self) -> Result<Expression, ApiError>`
...
`symi::api::Expression — pub fn substitute(&self, variable: &Expression, value: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_session_substitute.a2c4f6ed920e"></a>
`symi::api::Session — pub fn substitute(&self, target: &Expression, variable: &Expression, value: &Expression) -> Result<Expression, ApiError>`
...
`symi::api::algebra::Session — pub fn rewrite_in_terms_of(&self, target: &Expression, source: &Expression, replacement: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_expression_operations_expression_rewrite_in_terms_of.ddbe4b570e01"></a>
`symi::api::expression_operations::Expression — pub fn rewrite_in_terms_of(&self, source: &Expression, replacement: &Expression) -> Result<Expression, ApiError>`
...
`symi::api::Expression — pub fn free_variables(&self) -> Result<Vec<String>, ApiError>`
...
`symi::api::expression_operations::Expression — pub fn expression_type(&self) -> Result<ExpressionTypeName, ApiError>`
...
`symi::api::Expression — pub fn node_count(&self) -> Result<usize, ApiError>`

<a id="placement-placement.rust.native_rust.api_results_numericdefiniteintegrationresult_node_count.3fe1abe73c1c"></a>
`symi::api::results::NumericDefiniteIntegrationResult — pub fn node_count(&self) -> Option<usize>`
...
`symi::api::Expression — pub fn duplicate(&self) -> Result<Expression, ApiError>`
...
`symi::api::analysis::Session — pub fn evaluate_to_float(&self, input_expression: &Expression) -> Result<f64, ApiError>`

<a id="placement-placement.rust.native_rust.api_expression_operations_expression_evaluate_to_float.2d8aecc11d03"></a>
`symi::api::expression_operations::Expression — pub fn evaluate_to_float(&self) -> Result<f64, ApiError>`
...
`symi::api::analysis::Session — pub fn evaluate_to_complex_inexact(&self, input_expression: &Expression) -> Result<(f64, f64), ApiError>`
...
`symi::api::expression_operations::Expression — pub fn evaluate_to_complex_inexact(&self) -> Result<(f64, f64), ApiError>`
...
`symi::api::analysis::Session — pub fn evaluate_to_complex_inexact_at_precision(&self, input_expression: &Expression, precision_bits: u32) -> Result<(f64, f64), ApiError>`
...
`symi::api::expression_operations::Expression — pub fn evaluate_to_complex_inexact_at_precision(&self, precision_bits: u32) -> Result<(f64, f64), ApiError>`
...
`symi::api::expression_operations::Expression — pub fn equals(&self, other: &Expression) -> Result<bool, ApiError>`
...
`symi::api::Expression — pub fn is_matrix(&self) -> Result<bool, ApiError>`

<a id="placement-placement.rust.native_rust.api_matrix_operations_matrix_is_matrix.616418ad9772"></a>
`symi::api::matrix_operations::Matrix — pub fn is_matrix(&self) -> bool`
...
`symi::api::Expression — pub fn is_equality(&self) -> Result<bool, ApiError>`

<a id="placement-placement.rust.native_rust.api_matrix_operations_matrix_is_equality.dd84978d1bc9"></a>
`symi::api::matrix_operations::Matrix — pub fn is_equality(&self) -> bool`
...
`symi::api::Expression — pub fn is_integral(&self) -> Result<bool, ApiError>`

<a id="placement-placement.rust.native_rust.api_matrix_operations_matrix_is_integral.e36dc3a283a3"></a>
`symi::api::matrix_operations::Matrix — pub fn is_integral(&self) -> bool`
...
`symi::api::Expression — pub fn is_finite(&self) -> Result<TruthValue, ApiError>`


### is_defined

<a id="placement-placement.rust.native_rust.api_expression_is_defined.ae5a55e78924"></a>
`symi::api::Expression — pub fn is_defined(&self) -> Result<TruthValue, ApiError>`
...
`symi::api::Expression — pub fn interval_lower(&self) -> Result<Expression, ApiError>`
...
`symi::api::Expression — pub fn interval_upper(&self) -> Result<Expression, ApiError>`


### integral_integrand

<a id="placement-placement.rust.native_rust.api_expression_integral_integrand.f1dc499313e4"></a>
`symi::api::Expression — pub fn integral_integrand(&self) -> Result<Expression, ApiError>`


### integral_variable

<a id="placement-placement.rust.native_rust.api_expression_integral_variable.d67edcfa3712"></a>
`symi::api::Expression — pub fn integral_variable(&self) -> Result<String, ApiError>`


### integral_lower_bound

<a id="placement-placement.rust.native_rust.api_expression_integral_lower_bound.4607e3ddce95"></a>
`symi::api::Expression — pub fn integral_lower_bound(&self) -> Result<Option<Expression>, ApiError>`
...
`symi::api::Expression — pub fn integral_upper_bound(&self) -> Result<Option<Expression>, ApiError>`


### union_components

<a id="placement-placement.rust.native_rust.api_expression_union_components.c73de67ec53f"></a>
`symi::api::Expression — pub fn union_components(&self) -> Result<Vec<Expression>, ApiError>`
...
`symi::api::Expression — pub fn image_set_lambda_expression(&self) -> Result<Expression, ApiError>`


### image_set_variable

<a id="placement-placement.rust.native_rust.api_expression_image_set_variable.e0a0b6c8694d"></a>
`symi::api::Expression — pub fn image_set_variable(&self) -> Result<String, ApiError>`


### image_set_domain

<a id="placement-placement.rust.native_rust.api_expression_image_set_domain.02b2e75224d3"></a>
`symi::api::Expression — pub fn image_set_domain(&self) -> Result<Expression, ApiError>`


### to_list

<a id="placement-placement.rust.native_rust.api_expression_to_list.6f9a303ec887"></a>
`symi::api::Expression — pub fn to_list(&self) -> Result<Vec<Expression>, ApiError>`
...
`symi::api::partial_differential_equations::PartialDifferentialEquationProblem — pub fn to_string(&self) -> Result<String, ApiError>`
...
`symi::api::Expression — pub fn symbol_name(&self) -> Result<String, ApiError>`
...
`symi::api::Expression — pub fn numerator_denominator(&self) -> Result<(Expression, Expression), ApiError>`

<a id="placement-placement.rust.native_rust.api_session_numerator_denominator.de1f536ce5b1"></a>
`symi::api::Session — pub fn numerator_denominator(&self, target: &Expression) -> Result<(Expression, Expression), ApiError>`
...
`symi::api::Expression — pub fn numerator(&self) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_session_numerator.7305c9047cbc"></a>
`symi::api::Session — pub fn numerator(&self, target: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_results_numeratordenominator_numerator.017b447f3c19"></a>
`symi::api::results::NumeratorDenominator — pub fn numerator(&self) -> Expression`
...
`symi::api::Expression — pub fn denominator(&self) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_session_denominator.e65eed2eb5b5"></a>
`symi::api::Session — pub fn denominator(&self, target: &Expression) -> Result<Expression, ApiError>`

<a id="placement-placement.rust.native_rust.api_results_numeratordenominator_denominator.761a00c4f4ce"></a>
`symi::api::results::NumeratorDenominator — pub fn denominator(&self) -> Expression`
