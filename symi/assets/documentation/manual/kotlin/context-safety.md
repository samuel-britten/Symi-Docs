...
*Not exposed by the Kotlin bindings. Available as [`Context.execution_mode`](/symi/python/context-safety#execution_mode) in Python, [`api::Session::execution_mode`](/symi/rust/context-safety#execution_mode) in Rust.*
...
*Not exposed by the Kotlin bindings. Available as [`Context.simplify_bulk`](/symi/python/context-safety#simplify_bulk) in Python, [`api::Session::simplify_bulk`](/symi/rust/context-safety#simplify_bulk) in Rust.*
...
*Not exposed by the Kotlin bindings. Available as [`api::AssumptionScope::generation`](/symi/rust/context-safety#generation) in Rust.*
...
*Not exposed by the Kotlin bindings. Available as [`api::AssumptionScope::session`](/symi/rust/context-safety#session) in Rust.*
