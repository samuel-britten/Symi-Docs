...
*Not exposed by the Kotlin bindings. Available as [`api::DifferentialEquationSolutionScope`](/symi/rust/differential-equations#differentialequationsolutionscope) in Rust.*
